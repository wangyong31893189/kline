...
function (_Theme) {
  ...
  function DarkTheme() {
    ...
    if (__WEBPACK_IMPORTED_MODULE_0__kline__["a" /* default */].instance.reverseColor) {
      ...
      _this._colors[Theme.Color.Positive] = "#f00"; //涨的颜色
      // this._colors[Theme.Color.Negative] = "#19b34c";

      _this._colors[Theme.Color.Negative] = "#ff0"; //跌的颜色

      _this._colors[Theme.Color.PositiveDark] = "#3b0e08";
      _this._colors[Theme.Color.PositiveDark] = "#00f"; //深度图涨颜色

      _this._colors[Theme.Color.NegativeDark] = "#004718";
      _this._colors[Theme.Color.NegativeDark] = "#ff0"; //深度图跌颜色
    } else {
      // this._colors[Theme.Color.Positive] = "#19b34c";
      _this._colors[Theme.Color.Positive] = "#0f0"; //涨的颜色
    ...
    _this._colors[Theme.Color.Unchanged] = "#fff"; // this._colors[Theme.Color.Background] = "#0a0a0a";

    _this._colors[Theme.Color.Background] = "#f00"; //背景颜色
