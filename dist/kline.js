...
function () {
  function Kline(option) {
    ...
    __WEBPACK_IMPORTED_MODULE_4__templates__["b" /* Template */].showTimeline = this.showTimeline; // this.oldRange=this.range;//存储上一次的选择时间
      ...
      __WEBPACK_IMPORTED_MODULE_7_jquery___default()(document).ready(function () {
        ...
        __WEBPACK_IMPORTED_MODULE_7_jquery___default()('#chart_select_theme li a').click(function () {
          ...
          if (__WEBPACK_IMPORTED_MODULE_7_jquery___default()(this).attr('name') === 'dark') {
            ...
            __WEBPACK_IMPORTED_MODULE_0__control__["a" /* Control */].switchTheme('light');
          } else if (__WEBPACK_IMPORTED_MODULE_7_jquery___default()(this).attr('name') === 'default') {
            __WEBPACK_IMPORTED_MODULE_0__control__["a" /* Control */].switchTheme('default');
          }
        });
  ...
  _createClass(MainDataSource, [{
    ...
    value: function update(data) {
      ...
      if (__WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.refreshStatus) {
        ...
        var _len = this._dataItems.length;
        var lastIndex = _len - 1;
        ...
        for (_i = 0; _i < _cnt; _i++) {
          ...
          if (firstItem && firstItem.date >= _e[0]) {
            //如果第一个小于
            preArr.push({
              date: _e[0],
              open: _e[1],
            ...
            this._appendedCount++;
          } else if (lastItem && lastItem.date <= _e[0]) {
            appArr.push({
              date: _e[0],
              open: _e[1],
              high: _e[2],
          ...
          for (_n = 1; _n <= 4; _n++) {
            _d = this.calcDecimalDigits(_e[_n]);
            if (this._decimalDigits < _d) this._decimalDigits = _d;
          } // this._dataItems.push({
          //     date: e[0],
          //     open: e[1],
          //     high: e[2],
...
function (_Theme) {
  ...
  function DarkTheme() {
    ...
    if (__WEBPACK_IMPORTED_MODULE_0__kline__["a" /* default */].instance.reverseColor) {
      ...
      color_pos = '#2d7bff';
      _this._colors[Theme.Color.Positive] = color_pos; //涨的颜色
      ...
      _this._colors[Theme.Color.NegativeDark] = "#ffb2ad"; //深度图跌颜色
    } else {
      // this._colors[Theme.Color.Positive] = "#19b34c";
      color_pos = '#ff577a';
      _this._colors[Theme.Color.Positive] = color_pos; //k线涨的颜色
      // this._colors[Theme.Color.Negative] = "#990e0e";

      color_neg = '#2d7bff';
      _this._colors[Theme.Color.Negative] = color_neg; //k线跌的颜色
      // this._colors[Theme.Color.PositiveDark] = "#004718";

      _this._colors[Theme.Color.PositiveDark] = "#ffb2ad"; //深度图涨颜色
      // this._colors[Theme.Color.NegativeDark] = "#3b0e08";

      _this._colors[Theme.Color.NegativeDark] = "#5fd292"; //深度图跌颜色
    } // this._colors[Theme.Color.Unchanged] = "#fff";


    _this._colors[Theme.Color.Unchanged] = "#f00"; // this._colors[Theme.Color.Background] = "#0a0a0a";
    ...
    _this._colors[Theme.Color.Indicator0] = "#ddd"; //MA5线的颜色

    _this._colors[Theme.Color.Indicator1] = "#f00"; //MA10线的颜色

    _this._colors[Theme.Color.Indicator2] = "#f600ff"; //BOLL线颜色

    _this._colors[Theme.Color.Indicator3] = "#6bf"; //SAR线颜色

    _this._colors[Theme.Color.Indicator4] = "#a5cf81"; //未知

    _this._colors[Theme.Color.Indicator5] = "#e18b89"; //未知

    _this._colors[Theme.Color.Grid0] = "#f3f9ff"; // 水平线颜色 默认dash

    _this._colors[Theme.Color.Grid1] = "#444"; //网络颜色

    _this._colors[Theme.Color.Grid2] = "#666"; //未知

    _this._colors[Theme.Color.Grid3] = "#888"; //横向时间线标签提示边框颜色
    ...
    _this._colors[Theme.Color.Text0] = "#444"; //未知

    _this._colors[Theme.Color.Text1] = "#666"; //未知

    _this._colors[Theme.Color.Text2] = "#000"; //时间线标签颜色 
    ...
    _this._colors[Theme.Color.LineColorSelected] = "#ffffff"; //鼠标经过画线的颜色

    _this._colors[Theme.Color.CircleColorFill] = "#000000"; //画线工具画的线上圆点颜色

    _this._colors[Theme.Color.CircleColorStroke] = "#393c40"; //画线工具画的线上圆点边框颜色
...
function (_Theme2) {
  ...
  function LightTheme() {
    ...
    if (__WEBPACK_IMPORTED_MODULE_0__kline__["a" /* default */].instance.reverseColor) {
      // this._colors[Theme.Color.Positive] = "#990e0e";
      color_pos = '#2d7bff';
      _this2._colors[Theme.Color.Positive] = color_pos; //涨的颜色
      // this._colors[Theme.Color.Negative] = "#19b34c";
      ...
      _this2._colors[Theme.Color.NegativeDark] = "#ffb2ad"; //深度图跌颜色
    } else {
      // this._colors[Theme.Color.Positive] = "#19b34c";
      color_pos = '#ff577a';
      _this2._colors[Theme.Color.Positive] = color_pos; //k线涨的颜色
      // this._colors[Theme.Color.Negative] = "#990e0e";

      color_neg = '#2d7bff';
      _this2._colors[Theme.Color.Negative] = color_neg; //k线跌的颜色
      // this._colors[Theme.Color.PositiveDark] = "#004718";

      _this2._colors[Theme.Color.PositiveDark] = "#ffb2ad"; //深度图涨颜色
      // this._colors[Theme.Color.NegativeDark] = "#3b0e08";

      _this2._colors[Theme.Color.NegativeDark] = "#5fd292"; //深度图跌颜色
    } // this._colors[Theme.Color.Unchanged] = "#fff";
    ...
    _this2._colors[Theme.Color.Indicator0] = "#ddd"; //MA5线的颜色

    _this2._colors[Theme.Color.Indicator1] = "#f4bc0e"; //MA10线的颜色

    _this2._colors[Theme.Color.Indicator2] = "#f600ff"; //BOLL线颜色

    _this2._colors[Theme.Color.Indicator3] = "#6bf"; //SAR线颜色

    _this2._colors[Theme.Color.Indicator4] = "#a5cf81"; //未知

    _this2._colors[Theme.Color.Indicator5] = "#e18b89"; //未知

    _this2._colors[Theme.Color.Grid0] = "#f3f9ff"; // 水平线颜色 默认dash

    _this2._colors[Theme.Color.Grid1] = "#444"; //网络颜色

    _this2._colors[Theme.Color.Grid2] = "#666"; //未知

    _this2._colors[Theme.Color.Grid3] = "#888"; //横向时间线标签提示边框颜色
    ...
    _this2._colors[Theme.Color.Text0] = "#444"; //未知

    _this2._colors[Theme.Color.Text1] = "#666"; //未知

    _this2._colors[Theme.Color.Text2] = "#000"; //时间线标签颜色 
    ...
    _this2._colors[Theme.Color.LineColorSelected] = "#ffffff"; //鼠标经过画线的颜色

    _this2._colors[Theme.Color.CircleColorFill] = "#000000"; //画线工具画的线上圆点颜色

    _this2._colors[Theme.Color.CircleColorStroke] = "#393c40"; //画线工具画的线上圆点边框颜色
...
function (_Theme3) {
  ...
  function DefaultTheme() {
    ...
    _this3._colors[Theme.Color.Text44] = "#999"; //时间位置日期显示文字颜色   -----
...
function () {
  ...
  _createClass(Control, null, [{
    ...
    value: function requestData(showLoading) {
      ...
      } else if (__WEBPACK_IMPORTED_MODULE_0__kline__["a" /* default */].instance.type === "poll") {
    ...
    value: function requestOverData() {
      ...
      __WEBPACK_IMPORTED_MODULE_6_jquery___default()(document).ready(function () {
        var res = {
          success: true,
          data: __WEBPACK_IMPORTED_MODULE_0__kline__["a" /* default */].instance.data
        };
        this.range = __WEBPACK_IMPORTED_MODULE_0__kline__["a" /* default */].instance.range;
        this.symbol = __WEBPACK_IMPORTED_MODULE_0__kline__["a" /* default */].instance.symbol;
        Control.requestSuccessHandler(res);
      ...
      for (var i = first; i < last; i++) {
        ...
        if (n < cnt) {
          ...
          if (localDate % m === 0) {
            ...
            context.fillStyle = theme.getColor(__WEBPACK_IMPORTED_MODULE_6__themes__["d" /* Theme */].Color.Text44);
